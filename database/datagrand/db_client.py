...
from .db_filter import MultiFilter, SingleFilter
from .utils import init_db_config_file


def translate_datagrand_filter_to_sqlalchemy_filter():
    pass


class DatagrandDBClient(object):
    
    def __init__(self, db_config_file):
        init_db_config_file(db_config_file)     # TODO
    ...
    def get_object(self, model_obj, model_id):
        """根据主键单条数据
